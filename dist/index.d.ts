interface FunctionTypes {
    ...
    areaTrapezio: (baseMaior: number, baseMenor: number, altura: number) => number;
    ...
    perimetroTrapezio: (ladoA: number, ladoB: number, ladoC: number, ladoD: number) => number;
...
declare const _default: FunctionTypes;
export = _default;
