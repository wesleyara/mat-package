...
function validatorConversorMedidas(unidade, numero) {
...
function validatorConversorMoedas(moeda) {
...
function validatorOperacoes(n1, n2) {
...
function validatorMediaPonderada(array, arrayPesos) {
    const isArr = (0, class_validator_1.isArray)(array);
